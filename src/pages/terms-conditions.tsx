        ...
        <Container
            ...
            <FadeIn options={{type: "fade-in", direction: 'up'}}>
                <p><strong>Elitely</strong> (henceforth referred to as “Platform” or “We” or “Us” or “We”) is a
                    ...
                    Platform.
                    By using the service from the website, the you agree to be bound by these Terms of Agreement
                    (“Terms” or
                    “Agreement”).</p>
                ...
                <p><strong>Please read this Terms carefully before accessing or using the Service</strong>. You must
                    read,
                    agree with, and
            ...
            <FadeIn options={{type: "fade-in", direction: 'up'}}>
                ...
                <p>We take the privacy and security of your personal information seriously and implement reasonable
                    measures
                    to protect it. We will not disclose your personal information to any third party without your
                    consent,
